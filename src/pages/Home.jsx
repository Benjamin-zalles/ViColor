...
export default function Home({ fun1, fun2, fun3, fun4 }) {
      ...
      <div>
        <div className="home-primary-content">
          <div className="home-primary-content-text">
            ...
            <p>
              ...
              cual es, la incapacidad de distinguir ciertas tonalidades de la
              gama cromática).
            </p>
          </div>
          ...
          <div className="home-primary-content-figure">
            ...
            <img
              src={trianguloContorno}
              className="form-home triangulo-stroke"
            />
        ...
        <div className="home-tertiary-content">
          ...
          <div className="home-tertiary-content-cards">
            <CardsDal
              imgType={imgAcro}
              typeBlind="Acromático"
              clickModal={fun1}
            />
            <CardsDal
              imgType={imgProta}
              typeBlind="Protanopía"
              clickModal={fun2}
            />
            <CardsDal
              imgType={imgDeuta}
              typeBlind="Deuteranopía"
              clickModal={fun3}
            />
            <CardsDal
              imgType={imgTrita}
              typeBlind="Tritanopía"
              clickModal={fun4}
            />
            {/* <button onClick={fun}>click aqui</button> */}
          </div>
        </div>
          ...
          <div className="ishihara-content">
            <div className="ishihara-content-text">
              ...
              <p>
                ...
                diagnosticar y clasificar las alteraciones de la visión del
                color (discromatopsias), comúnmente conocidas como daltonismo.
              </p>
              <p>
                Existen varios tipos de pruebas que se utilizan para
                diagnosticar el daltonismo, siendo la más utilizada:
              </p>
